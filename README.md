...
<img src=".github/lms-logo.png" alt="Dagu Learning logo" width="80" height="80"/>
<h1>Dagu Learning</h1>
...
## Dagu Learning
Dagu Learning is an easy-to-use learning system that helps you bring structure to your content.
...
Follow these steps to set up Dagu Learning in production:
...
The script will set up a production-ready instance of Dagu Learning with all the necessary configurations in about 5 minutes.
